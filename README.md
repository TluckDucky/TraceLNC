...
![Badge algorithm](http://img.shields.io/static/v1?label=Taco_run&message=v0.10.4&color=9cf)
![Badge algorithm](http://img.shields.io/static/v1?label=bedToGenePred&message=v0.10.4&color=9cf)
![Badge algorithm](http://img.shields.io/static/v1?label=genePredToGtf&message=v0.10.4&color=9cf)
