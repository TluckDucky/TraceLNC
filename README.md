<h1 align="center"> TracerLNC - Pipeline for human <strong>T</strong>ranscriptome <strong>A</strong>ssembly and <strong>C</strong>ore <strong>E</strong>valuation of novel <strong>lnc</strong>RNAs </h1>
